...
namespace RayTracing
{
    public partial class Form1 : Form
    {
        ...
        public void build_scene()
        {
            ...
            room.set_pen(new Pen(Color.DarkOliveGreen));
            ...
            room.sides[1].drawing_pen = new Pen(Color.Gray);
            ...
            room.sides[2].drawing_pen = new Pen(Color.DarkBlue);
            ...
            room.sides[3].drawing_pen = new Pen(Color.DarkGreen);
