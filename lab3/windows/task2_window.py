...
class Task2Window:
    def __init__(self, root: tk.Tk, parent):
        ...
        label_bresenham = tk.Label(
            self.root, text="Алгоритм Брезенхема", bg=parent.back_ground
        )
        label_bresenham.grid(row=0, column=0, padx=10)
        label_wu = tk.Label(self.root, text="Алгоритм Ву", bg=parent.back_ground)
